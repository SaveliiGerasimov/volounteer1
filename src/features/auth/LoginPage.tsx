...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-950 flex flex-col items-center justify-center p-4 text-gray-900 dark:text-neutral-50 transition-colors duration-300">
      ...
      >
        <h1 className="text-3xl font-bold mb-2 text-center text-gray-900 dark:text-white">Вход</h1>
        <p className="text-gray-500 dark:text-neutral-400 text-center mb-8">С возвращением!</p>
